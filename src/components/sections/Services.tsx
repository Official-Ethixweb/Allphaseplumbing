...
function PlumbingRepairIcon() {
  return (
    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      {/* Water drop */}
      <path d="M26 68 C26 68 12 82 12 93 C12 102 18 110 26 110 C34 110 40 102 40 93 C40 82 26 68 26 68Z" fill="#F5C842"/>
      <ellipse cx="21" cy="92" rx="4" ry="7" fill="white" fillOpacity="0.35" transform="rotate(-20 21 92)"/>
      {/* Wrench handle diagonal */}
      <rect x="70" y="14" width="14" height="60" rx="7" fill="#F5C842" transform="rotate(-42 77 44)"/>
      {/* Wrench top jaw */}
      <path d="M90 16 C90 16 108 14 112 26 C114 32 110 40 104 40 L96 38 L100 28 Z" fill="#F5C842"/>
      <path d="M96 26 C96 26 108 24 110 30" stroke="#d4a820" strokeWidth="2.5" strokeLinecap="round"/>
      {/* Wrench bottom jaw */}
      <path d="M36 76 C36 76 18 78 14 66 C12 60 16 52 22 52 L30 54 L26 64 Z" fill="#F5C842"/>
      <path d="M30 66 C30 66 18 68 16 62" stroke="#d4a820" strokeWidth="2.5" strokeLinecap="round"/>
    </svg>
  );
}
...
function SewerServiceIcon() {
  return (
    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <line x1="60" y1="8" x2="60" y2="28" stroke="#F5C842" strokeWidth="4" strokeLinecap="round" strokeDasharray="5 4"/>
      ...
      <path
        ...
        stroke="#1E3A6E" strokeWidth="22" fill="none" strokeLinecap="round" strokeLinejoin="round"
      />
      {/* Pipe shine on U-bend */}
      <path
        d="M48 44 Q18 44 18 72 Q18 90 36 92"
        stroke="#4A7BC4" strokeWidth="6" fill="none" strokeLinecap="round" strokeOpacity="0.45"
      />
      {/* Yellow coupling ring at bottom-left of bend */}
      <rect x="20" y="76" width="20" height="12" rx="6" fill="#F5C842" transform="rotate(-20 30 82)"/>
      {/* Yellow coupling ring at bottom-right */}
      <rect x="80" y="76" width="20" height="12" rx="6" fill="#F5C842" transform="rotate(20 90 82)"/>
...
function ServiceCard({ svc }: { svc: typeof SERVICES[number] }) {
  return (
    ...
    >
      {/* Icon area */}
      <div className="flex items-center justify-center bg-[#f0f5ff] px-8 pt-10 pb-6
      ...
      <div className="px-6 py-6 flex flex-col flex-1">
        <h3 className="text-[22px] font-extrabold text-[#1E3A6E] leading-snug">
          {svc.title}
        </h3>
        <p className="text-gray-500 mt-2 text-[16px] leading-relaxed flex-1">
          {svc.description}
        </p>
        <span className="inline-flex items-center gap-1.5 text-[#1E3A6E] font-bold text-[16px]
