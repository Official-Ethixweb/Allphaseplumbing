...
function PostCard({ post }: { post: WPPost }) {
  ...
  return (
    <article className="group rounded-xl overflow-hidden shadow-md hover:shadow-[0_8px_30px_rgba(91,155,213,0.4)] hover:-translate-y-1 transition-all duration-300 cursor-pointer" style={{ background: "#5B9BD5" }}>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <StarBorder
            ...
            innerStyle={{ background: "linear-gradient(135deg,#1E3A6E 0%,#4A7BC4 100%)", border: "none", padding: "12px 28px" }}
          >
